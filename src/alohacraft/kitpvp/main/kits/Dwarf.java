...
public class Dwarf {
	...
	public void l1(final Player player) {
		...
		bchestMeta.setDisplayName(ChatColor.DARK_RED + "Level 1 Dwarf Sword");
	...
	public void l2(final Player player) {
		...
		ItemStack bchest = new ItemStack(Material.IRON_AXE, 1);
		ItemMeta bchestMeta = bchest.getItemMeta();
		bchestMeta.setDisplayName(ChatColor.DARK_RED + "Level 2 Dwarf Sword");
		bchest.setItemMeta(bchestMeta);
	...
	public void l3(final Player player) {
		...
		ItemStack bchest = new ItemStack(Material.IRON_AXE, 1);
		ItemMeta bchestMeta = bchest.getItemMeta();
		bchestMeta.setDisplayName(ChatColor.DARK_RED + "Level 3 Dwarf Sword");
		bchest.setItemMeta(bchestMeta);
		int bchestEffect = 16;
		int bchestEnhantmentLevel = 1;
		EnchantmentWrapper bchestEnhantment = new EnchantmentWrapper(bchestEffect);
	...
	public void l4(final Player player) {
		Util.resetInv(player);
		ItemStack bchest = new ItemStack(Material.DIAMOND_AXE, 1);
		ItemMeta bchestMeta = bchest.getItemMeta();
		bchestMeta.setDisplayName(ChatColor.DARK_RED + "Level 4 Dwarf Sword");
		bchest.setItemMeta(bchestMeta);
		int bchestEffect = 16;
		int bchestEnhantmentLevel = 1;
		EnchantmentWrapper bchestEnhantment = new EnchantmentWrapper(bchestEffect);
	...
	public void l5(final Player player) {
		...
		ItemStack bchest = new ItemStack(Material.DIAMOND_AXE, 1);
		ItemMeta bchestMeta = bchest.getItemMeta();
		bchestMeta.setDisplayName(ChatColor.DARK_RED + "Level 5 Dwarf Sword");
		bchest.setItemMeta(bchestMeta);
		int bchestEffect = 16;
